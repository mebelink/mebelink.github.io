(function ( $, x5engine ) {
	...
	s.siteId = '6621BB7A10765027798BEFB47465BC3A';
	...
	b.push(function () {
		x.stickyBar({
			enabledBreakpoints: ['160760e840de2d0fd277e114cbe95c1c','d2f9bff7f63c0d6b7c7d55510409c19b','72e5146e7d399bc2f8a12127e43469f1','5ecdcca63de80fd3d4fbb36295d22b7d']
		});
	});
	...
	b.push(function() { x.passwordpolicy.init({ "requiredPolicy": "true", "minimumCharacters": "9", "includeUppercase": "true", "includeNumeric": "true", "includeSpecial": "true" });
	});

	// BreakPoints
	s.breakPoints.push({"name": "Desktop", "hash": "160760e840de2d0fd277e114cbe95c1c", "start": "max", "end": 1170, "fluid": false});
	s.breakPoints.push({"name": "Breakpoint 1", "hash": "d2f9bff7f63c0d6b7c7d55510409c19b", "start": 1169.9, "end": 720, "fluid": false});
