...
$imSettings['general'] = array(
	...
	'public_folder' => '',
	'salt' => 'kd4hvavtth9fy31bh56plv3jgf0cqpibp1bp6omcf99vvx0ivihr',
...
$imSettings['admin'] = array(
	'notification_public_key' => '560c82d660f42073',
	'notification_private_key' => '305bce18c79e2407',
...
$ImMailer->header = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">' . "\n" . '<html>' . "\n" . '<head>' . "\n" . '<meta http-equiv="content-type" content="text/html; charset=utf-8">' . "\n" . '</head>' . "\n" . '<body bgcolor="rgba(63, 62, 62, 1)" style="background-color: rgba(63, 62, 62, 1);">' . "\n\t" . '<table border="0" cellpadding="0" align="center" cellspacing="0" style="padding: 0; margin: 0 auto; width: 700px;">' . "\n\t" . '<tr><td id="imEmailContent" style="min-height: 300px; padding: 10px; font: normal normal normal 9pt \'Raleway\'; color: rgba(0, 0, 0, 1); background-color: rgba(255, 255, 255, 1); text-align: left; text-decoration: none;  width: 700px;border-style: solid; border-color: rgba(128, 128, 128, 1); border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;background-color: rgba(255, 255, 255, 1)" width="700px">' . "\n\t\t";
...
$ImMailer->emailContentStyle = 'font: normal normal normal 9pt \'Raleway\'; color: rgba(0, 0, 0, 1); background-color: rgba(255, 255, 255, 1); text-align: left; text-decoration: none; ';
